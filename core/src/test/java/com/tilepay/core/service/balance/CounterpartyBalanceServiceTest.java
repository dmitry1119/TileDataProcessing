...
public class CounterpartyBalanceServiceTest {
    ...
    public void getBalancesWithTilecoinX() {
        ...
        assertBalance(counterpartyBalances.get(0), "12345", BigInteger.ZERO, CurrencyEnum.TILECOINX.name());
    }
    ...
    public void getBalancesWithTilecoinX1() {
        List<CounterpartyBalance> counterpartyBalances = new ArrayList<>(asList(
                ...
                aCounterpartyBalance().setAsset(CurrencyEnum.TILECOINX.name()).build(),
        ...
        assertBalance(balances.get(0), null, BigInteger.ZERO, CurrencyEnum.TILECOINX.name());
