...
import com.tilepay.domain.entity.MessageBuilder;
...
public class WalletController {
    ...
    public String index(Model model) {
        ...
        List<BTCTransactionDto> transactions = bitcoinService.convertTransactionsToBTCTransactionsDTO(account.getId());
    ...
    public String prefilledFeeTransaction(Model model, @ModelAttribute("transactionForm") TransactionDto form) {
        ...
        Asset asset = AssetBuilder.anAsset().setCntrprtyProtocol().setName("TILECOINX").setDivisible(false).build();
    ...
    public String createAsset(@Valid @ModelAttribute("assetIssuanceForm") AssetIssuanceDto form, BindingResult result, Model model, Locale locale) {
        ...
        AssetCreationResult assetCreationResult = walletWebService.createAsset(form);
    ...
    private void prepareModel(Model model) {
        ...
        model.addAttribute("issuanceTransactions", tilecoinRestClient.getIssuanceTransactions(account.getWallet().getAddress().getAddress()));
