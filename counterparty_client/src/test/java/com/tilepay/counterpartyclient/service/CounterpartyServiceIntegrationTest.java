...
public class CounterpartyServiceIntegrationTest {
    ...
    public void getBalances() {
        List<CounterpartyBalance> balances = counterpartyService.getBalances("mk3gU4wM7uxukTbf9DfFXNboQmQiSb9Qu1", "TILECOINX");
    ...
    public void getAssetInfos() {
        List<AssetInfo> asset_info = counterpartyService.getAssetInfos("TILECOINX", "XCP");
