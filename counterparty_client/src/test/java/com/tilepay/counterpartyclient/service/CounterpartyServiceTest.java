...
public class CounterpartyServiceTest {
    ...
    public void parseAssetInfos() {
        List<AssetInfo> assets = counterpartyService.parseAssetInfos(
                "[{\"owner\":\"msZETr3jAoa2HtrYBxyS6s4MgxDxa7nbqi\",\"call_date\":0,\"callable\":false,\"divisible\":true,\"call_price\":0.0,\"description\":\"100000000\",\"locked\":false,\"asset\":\"TILECOINX\",\"supply\":10000000000000000,\"issuer\":\"msZETr3jAoa2HtrYBxyS6s4MgxDxa7nbqi\"},"
        ...
        assertEquals("TILECOINX", assets.get(0).getAsset());
    ...
    public void parseSends() {
        List<CounterpartySend> sends = counterpartyService.parseSends(
                "[{\"quantity\": 100000000000,  \"destination\": \"mq373re9nGVN6Dwaynpo8KMdFMotUcuooa\", \"tx_hash\": \"f0571cfda320f1d663ad4721f03caaf8958e2d4fc71373e3c524984df7ed7c19\", \"block_index\": 312212, \"source\": \"msZETr3jAoa2HtrYBxyS6s4MgxDxa7nbqi\", \"tx_index\": 36, \"asset\": \"TILECOINX\", \"status\": \"valid\"}]");
